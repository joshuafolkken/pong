...
func load_settings(section: String, key: String) -> Variant:
...
func load_double_paddle() -> bool:
	return load_settings(DOUBLE_PADDLE[0], DOUBLE_PADDLE[1])
...
func load_retro_mode() -> bool:
	return load_settings(RETRO_MODE[0], RETRO_MODE[1])
...
func load_full_screen() -> bool:
	return load_settings(FULL_SCREEN[0], FULL_SCREEN[1])
